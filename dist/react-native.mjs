  ...
  ({ transaction, showDate = true }) => {
    ...
    return /* @__PURE__ */ jsxs2(View4, { style: styles4.txnRow, children: [
      ...
      /* @__PURE__ */ jsxs2(View4, { style: styles4.flex, children: [
        ...
        showDate && transaction.claimed_at && /* @__PURE__ */ jsx4(Text2, { style: styles4.date, children: new Date(transaction.claimed_at).toLocaleDateString("en-US", { day: "2-digit", month: "short" }) + " " + new Date(transaction.claimed_at).toLocaleTimeString("en-US", { hour: "2-digit", minute: "2-digit", hour12: true }) })
      ] }),
