  ...
  ({ transaction, showDate = true }) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_react_native5.View, { style: styles4.txnRow, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_react_native5.View, { style: styles4.flex, children: [
        ...
        showDate && transaction.claimed_at && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_react_native5.Text, { style: styles4.date, children: new Date(transaction.claimed_at).toLocaleDateString("en-US", { day: "2-digit", month: "short" }) + " " + new Date(transaction.claimed_at).toLocaleTimeString("en-US", { hour: "2-digit", minute: "2-digit", hour12: true }) })
      ] }),
